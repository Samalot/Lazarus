...
package lazarus.utilities.packets.server;
import lazarus.main.LazarusMain;
import lazarus.utilities.packets.AbstractMessage.AbstractServerMessage;
...
public class OpenGuiMessage extends AbstractServerMessage<OpenGuiMessage>
{
	...
	public void process(EntityPlayer player, Side side) {
		...
		player.openGui(LazarusMain.instance, this.id, player.worldObj, (int) player.posX, (int) player.posY, (int) player.posZ);
	}
