...
public class GuiTokenPouch extends GuiContainer
{
	...
	private static final ResourceLocation iconLocation = new ResourceLocation("lazarus:textures/gui/token_pouch_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		...
		fontRendererObj.drawString(s, (xSize / 2 - fontRendererObj.getStringWidth(s) / 2)+37, ySize - 125 + 4, 4210752);
		fontRendererObj.drawString(I18n.format("container.inventory"), 100, ySize - 96 + 4, 4210752);
	}
